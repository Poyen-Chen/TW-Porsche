...
- name: SentenceTransformer based on nomic-ai/nomic-embed-text-v1.5
  ...
  - task:
    ...
    - type: cosine_ndcg@10
      value: 0.7143265352028126
      name: Cosine Ndcg@10
    - type: cosine_mrr@10
      value: 0.6677755731922399
      name: Cosine Mrr@10
    - type: cosine_map@100
      value: 0.6741102914393938
      name: Cosine Map@100
    - type: cosine_accuracy@1
    ...
    - type: cosine_accuracy@5
      ...
      name: Cosine Accuracy@5
    - type: cosine_accuracy@10
      value: 0.8555555555555555
      name: Cosine Accuracy@10
    - type: cosine_precision@1
      value: 0.5222222222222223
      name: Cosine Precision@1
    - type: cosine_precision@3
      value: 0.2388888888888889
      name: Cosine Precision@3
    - type: cosine_precision@5
      value: 0.15777777777777777
      name: Cosine Precision@5
    - type: cosine_precision@10
      value: 0.08555555555555554
      name: Cosine Precision@10
    - type: cosine_recall@1
      value: 0.5222222222222223
      name: Cosine Recall@1
    ...
    - type: cosine_recall@10
      ...
      name: Cosine Recall@10
    - type: cosine_ndcg@10
      value: 0.6855390789737882
      name: Cosine Ndcg@10
    - type: cosine_mrr@10
      value: 0.6311529982363315
      name: Cosine Mrr@10
    - type: cosine_map@100
      value: 0.6361931225617495
      name: Cosine Map@100
---
...
| **cosine_ndcg@10**  | **0.7143** |
| cosine_mrr@10       | 0.6678     |
| cosine_map@100      | 0.6741     |
...
| Metric              | Value      |
|:--------------------|:-----------|
| cosine_accuracy@1   | 0.5222     |
| cosine_accuracy@3   | 0.7167     |
| cosine_accuracy@5   | 0.7889     |
| cosine_accuracy@10  | 0.8556     |
| cosine_precision@1  | 0.5222     |
| cosine_precision@3  | 0.2389     |
| cosine_precision@5  | 0.1578     |
| cosine_precision@10 | 0.0856     |
| cosine_recall@1     | 0.5222     |
| cosine_recall@3     | 0.7167     |
| cosine_recall@5     | 0.7889     |
| cosine_recall@10    | 0.8556     |
| **cosine_ndcg@10**  | **0.6855** |
| cosine_mrr@10       | 0.6312     |
| cosine_map@100      | 0.6362     |
...
| 0      | 0    | -             | -               | 0.6725                             |
| 0.5556 | 100  | 0.1309        | -               | -                                  |
| 1.0    | 180  | -             | 0.0359          | 0.7130                             |
| 1.1111 | 200  | 0.0945        | -               | -                                  |
| 1.6667 | 300  | 0.0317        | -               | -                                  |
| 2.0    | 360  | -             | 0.0245          | 0.7108                             |
| 2.2222 | 400  | 0.0378        | -               | -                                  |
| 2.7778 | 500  | 0.0124        | -               | -                                  |
| 3.0    | 540  | -             | 0.0234          | 0.6855                             |
